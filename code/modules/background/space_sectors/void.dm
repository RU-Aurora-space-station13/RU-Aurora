...
/datum/space_sector/lights_edge//Uses the Weeping Stars attributes since it's neighboring and this is not exactly the void just yet
	...
	description = "Необычное место, почти не заселённое даже в наше время, Край Света был самым удалённым регионом в рамках Юго-Восточной экспансии Альянса. \
	...
	полностью лишённого звёзд. И Край Света и Море Лемур являются домом для множестве неизвестных науке феноменов, из за чего, концентрация учёных в этом регионе зашкаливает."
...
/datum/space_sector/lemurian_sea//The actual proposed area of void as written. Should be as dark as possible, due to no starlight
	...
	лишь недавно оно было признано отдельным от Края Света объектом. В целом, путешественникам не рекомендуется здесь летать: очень многие сообщают о \
