...
/datum/event/meteor_wave/announce()
	command_announcement.Announce(current_map.meteors_detected_message, "Тревога: Метеоры", new_sound = 'sound/AI/meteors_detected_message.ogg', zlevels = affecting_z)

/datum/event/meteor_wave/announce_start()
	. = ..()
	if(.)
		command_announcement.Announce(current_map.meteor_contact_message, "Тревога: Метеоры", zlevels = affecting_z)
...
/datum/event/meteor_wave/announce_end(var/faked)
	...
	if(.)
		spawn(100)//We give 10 seconds before announcing, for the last wave of meteors to hit the station
			command_announcement.Announce(current_map.meteor_end_message, "Тревога: Метеоры", zlevels = affecting_z)
...
/datum/event/meteor_wave/downed_ship/announce()
	command_announcement.Announce(current_map.ship_meteor_end_message, "Тревога: Обломки", new_sound = 'sound/AI/meteor_end_message.ogg', zlevels = affecting_z)

/datum/event/meteor_wave/downed_ship/announce_start()
	. = ..()
	if(.)
		command_announcement.Announce(current_map.ship_meteor_contact_message, "Тревога: Обломки", new_sound = 'sound/AI/meteor_contact_message.ogg', zlevels = affecting_z)
...
/datum/event/meteor_wave/dust/announce()
	command_announcement.Announce(current_map.dust_detected_message, "Тревоаг: Космическая пыль", new_sound = 'sound/AI/dust_detected_message.ogg', zlevels = affecting_z)

/datum/event/meteor_wave/dust/announce_start()
	. = ..()
	if(.)
		command_announcement.Announce(current_map.dust_contact_message, "Тревога: Космическая пыль", new_sound = 'sound/AI/dust_contact_message.ogg', zlevels = affecting_z)
...
/datum/event/meteor_wave/dust/announce_end(var/faked)
	...
	if(.)
		spawn(100)//We give 10 seconds before announcing, for the last wave of meteors to hit the station
			command_announcement.Announce(current_map.dust_end_message, "Тревога: Космическая пыль", , new_sound = 'sound/AI/dust_end_message.ogg', zlevels = affecting_z)
