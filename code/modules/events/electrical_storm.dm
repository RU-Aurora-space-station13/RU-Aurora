...
/datum/event/electrical_storm/announce()
	switch(severity)
		if(EVENT_LEVEL_MUNDANE)
			command_announcement.Announce("Внимание экипажу: слабый электромагнитный шторм.", "Сенсоры [location_name()]", new_sound = 'sound/AI/electrical_storm.ogg', zlevels = affecting_z)
		if(EVENT_LEVEL_MODERATE)
			command_announcement.Announce("Внимание экипажу: электрический шторм. Избегайте вреда чувствительному оборудованию.", "Сенсоры [location_name()]", new_sound = 'sound/AI/electrical_storm.ogg', zlevels = affecting_z)
		if(EVENT_LEVEL_MAJOR)
			command_announcement.Announce("Внимание экипажу: сильный электрический шторм. Немедленно отключите чувствительное оборудование.", "Сенсоры [location_name()]", new_sound = 'sound/AI/electrical_storm.ogg', zlevels = affecting_z)
